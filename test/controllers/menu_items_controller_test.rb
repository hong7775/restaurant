...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post menu_items_url, params: { menu_item: { category_id: @menu_item.category_id, description: @menu_item.description, name: @menu_item.name, unit_price: @menu_item.unit_price } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { category_id: @menu_item.category_id, description: @menu_item.description, name: @menu_item.name, unit_price: @menu_item.unit_price } }
